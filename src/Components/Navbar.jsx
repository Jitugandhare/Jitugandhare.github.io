        ...
        >
                ...
                <DrawerBody fontFamily={"cursive"} color={"white"} bg="#171518">
                  ...
                  >
                    <Link
                      ...
                      borderRadius={"5px"}
                      backgroundImage={
                        "linear-gradient(to right, #25cefd, cyan.500)"
                      }
                      fontFamily={"cursive"}
                    ...
                    >
                      <Button
                        onClick={() =>
                          openResume(
                            "https://drive.google.com/drive/folders/1s4XhCOvDAFMZo1y_Bb1mgG3sDG12XQ2z?usp=sharing"
                          )
                        }
                        backgroundImage={
                          "linear-gradient(to right, #25cefd, cyan.500)"
          ...
          >
            ...
            <Link
              fontWeight={"bold"}
              borderRadius={"5px"}
              backgroundImage={"linear-gradient(to right, #25cefd, cyan.50)"}
              fontFamily={"cursive"}
              className="nav-link resume"
              id="resume-button-1"
              href={resume}
